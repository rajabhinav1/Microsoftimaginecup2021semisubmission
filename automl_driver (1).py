...
workspace_name = "abhinav" # PLACEHOLDER
subscription_id = "ac5dbce5-415f-45b6-b2e1-0306c6153eba" # PLACEHOLDER
resource_group = "Imaginecupsubmission" # PLACEHOLDER
experiment_name = "obesityindexcplumnobesity" # PLACEHOLDER
iteration = "8"  # PLACEHOLDER
run_id = "AutoML_39a5ca22-a0d3-4b99-acda-8de2ebaeb022_8"  # PLACEHOLDER
entry_point = "get_data.py" # PLACEHOLDER
automl_settings = {'enable_early_stopping':True,'enable_ensembling':True,'enable_stack_ensembling':True,'ensemble_iterations':15,'enable_onnx_compatible_models':False,'max_cores_per_iteration':-1,'send_telemetry':True,'blacklist_algos':['TensorFlowLinearClassifier','TensorFlowDNN'],'compute_target':'flash3','enable_dnn':False,'experiment_exit_score':None,'experiment_timeout_minutes':15,'featurization':'auto','is_timeseries':False,'iteration_timeout_minutes':15,'max_concurrent_iterations':2,'metric_operation':'maximize','model_explainability':True,'n_cross_validations':None,'name':'obesityindexcplumnobesity','path':'./sample_projects/obesityindexcplumnobesity','primary_metric':'accuracy','region':'eastus2','resource_group':'Imaginecupsubmission','subscription_id':'ac5dbce5-415f-45b6-b2e1-0306c6153eba','task_type':'classification','validation_size':None,'vm_type':'STANDARD_D2_V2','workspace_name':'abhinav','label_column_name':'No_Exercise'} # PLACEHOLDER
pipeline_spec = "{\"pipeline_id\":\"__AutoML_Ensemble__\",\"objects\":[{\"module\":\"azureml.train.automl.ensemble\",\"class_name\":\"Ensemble\",\"spec_class\":\"sklearn\",\"param_args\":[],\"param_kwargs\":{\"automl_settings\":\"{'task_type':'classification','primary_metric':'accuracy','ensemble_iterations':15,'is_timeseries':False,'name':'obesityindexcplumnobesity','compute_target':'flash3','subscription_id':'ac5dbce5-415f-45b6-b2e1-0306c6153eba','region':'eastus2'}\",\"ensemble_run_id\":\"AutoML_39a5ca22-a0d3-4b99-acda-8de2ebaeb022_8\",\"experiment_name\":\"obesityindexcplumnobesity\",\"workspace_name\":\"abhinav\",\"subscription_id\":\"ac5dbce5-415f-45b6-b2e1-0306c6153eba\",\"resource_group_name\":\"Imaginecupsubmission\"}}]}" # PLACEHOLDER
pipeline_id = "__AutoML_Ensemble__" # PLACEHOLDER
dataprep_json = "{\"datasets\":0,\"training_data\":{\"datasetId\":\"428d1d16-d2e2-4bee-8426-24e0510059df\"}}" # PLACEHOLDER
